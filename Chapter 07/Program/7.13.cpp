...
int main(){
 ...
 for (int index = 0; index < NUM_EMPLOYEES; index++){//khoi tao vong lap de nhap vao gia tri cua cac phan tu trong mang hours
 ...
 for (int index = 0; index < NUM_EMPLOYEES; index++){//khoi tao vong lap de xuat ra ket qua
