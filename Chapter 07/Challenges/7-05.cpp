...
double getAverage(const double array[][COLUMNS]){//khoi tao ham getAverage gom mang thuc hai chieu 
...
double getLeast(const double array[][COLUMNS]){//khoi tao ham getLeast gom mang thuc hai chieu 
...
double getHighest(const double array[][COLUMNS]){//khoi tao ham getHighest gom mang thuc hai chieu 
    double sum, //khoi tao bien thuc sum va mang thuc local_array[ROWS]
           local_array[ROWS];
    for(int row = 0; row < ROWS; row++){//khoi tao vong lap duyet cac gia tri cua dong
