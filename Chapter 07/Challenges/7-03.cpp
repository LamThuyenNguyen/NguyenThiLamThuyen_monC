...
int inputValidate(int user_number){//khoi tao ham nguyen inputValidate gom bien nguyen
...
void getNumberSold(const string names_array[], int values_array[], const int SIZE){//khoi tao ham getNumberSold gom mang hang xau ky tu, bien nguyen, va hang nguyen
...
int getTotal(const int array[], const int SIZE){//khoi tao ham getTotal gom mang hang xau ky tu va hang nguyen
    int total = 0;//cho bien total bang 0
    for (int i = 0; i < SIZE; i++)//khoi tao vong lap
        total += array[i];//cong va gan gia tri cho bien total
    return total;
}
string getHighest(const string array1[], const int array2[], int ARRAY_SIZE){//khoi tao ham getHighest gom mang hang xau ky tu, mang hang nguyen va hang nguyen
...
string getLowest(const string array1[], const int array2[], int ARRAY_SIZE){//khoi tao ham getLowest gom mang hang xau ky tu, mang hang nguyen va hang nguyen
